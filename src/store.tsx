...
export function RoomProvider({ children }: { children: ReactNode }) {
  ...
  // A visitor may walk and pose the character too, so an entered room is something to play with rather than a
  // picture. It stays local: characterTracker only persists and publishes the position when this is your own room,
  // so nothing a visitor does here reaches the owner's saved room.
