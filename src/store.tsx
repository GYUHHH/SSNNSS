...
type RoomStore = {
  ...
  // how that character is standing — seated, laid down, which way it faces. Null in the live room, where the pose
  // is whatever the user is doing right now; a neighbour needs the one its owner was last found in.
