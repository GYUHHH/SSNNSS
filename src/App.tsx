...
function Interface() {
  ...
  // 하단 법적 고지 링크는 #root 밖(index.html)에 있어 body에도 표시를 남겨야 같이 숨는다
  useEffect(() => {
