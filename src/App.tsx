...
function Interface() {
  ...
  return <main className={artOpen ? 'app art-open' : 'app'}>
    ...
    <ItemComments />
    <ProfileCard />
    {/* mounted for good, like the art sheet below: a panel that only exists while it is open can animate its way
        in but vanishes on the way out, which is what made the 가구함 pop shut instead of sliding */}
    <InventoryPanel open={mode === 'edit' && inventoryOpen} />
