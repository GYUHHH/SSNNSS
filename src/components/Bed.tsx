...
export default function Bed() {
  ...
  return <Furniture id="bed">
    ...
    <RoundedBox castShadow args={[1.28, 0.22, 1.3]} radius={0.09} smoothness={2} position={[0, 0.68, 0.28]}><meshStandardMaterial color={accent} roughness={0.9} /></RoundedBox>

    <RoundedBox castShadow args={[0.5, 0.16, 0.5]} radius={0.07} smoothness={2} rotation={[0, 0.08, 0]} position={[-0.3, 0.78, -0.62]}><meshStandardMaterial color={palette.linen} roughness={0.85} /></RoundedBox>
    <RoundedBox castShadow args={[0.5, 0.16, 0.5]} radius={0.07} smoothness={2} rotation={[0, -0.06, 0]} position={[0.3, 0.78, -0.6]}><meshStandardMaterial color={palette.linen} roughness={0.85} /></RoundedBox>
  </Furniture>
}
