...
export function PhotoCropEditor({ source, aspect = 4 / 3, output = [800, 600], onApply, onClose }: { source: string; aspect?: number; output?: [number, number]; onApply: (image: string) => void; onClose: () => void }) {
