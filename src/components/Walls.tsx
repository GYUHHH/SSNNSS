...
export default function Walls() {
  ...
  return <>
    ...
    {/* trim bars: square channels under each wall plus the open corner column between the walls */}
    <mesh receiveShadow position={[-3.61, -0.11, -0.11]}><boxGeometry args={[.22, .22, 7.22]} /><meshStandardMaterial color={TRIM_COLOR} /></mesh>
    <mesh receiveShadow position={[0, -0.11, -3.61]}><boxGeometry args={[7, .22, .22]} /><meshStandardMaterial color={TRIM_COLOR} /></mesh>
    <mesh receiveShadow position={[-3.61, 3.5, -3.61]}><boxGeometry args={[.22, 7, .22]} /><meshStandardMaterial color={TRIM_COLOR} /></mesh>
