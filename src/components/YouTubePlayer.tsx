...
import { videoResumeKey } from '../services/ytResume'
...
export default function YouTubePlayer() {
  const { playingFrames, videoLinks, selectedObject, furniture, currentHandle } = useRoomStore()
  ...
  const resumeKey = videoResumeKey(currentHandle, docked)
  return <section className="yt-player docked" aria-label="유튜브 재생">
    <ResumingIframe key={resumeKey} videoId={videoId} frameId={docked} resumeKey={resumeKey} extra="autoplay=1&playsinline=1&mute=1" />
  </section>
}
