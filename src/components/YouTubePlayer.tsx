...
export default function YouTubePlayer() {
  const { playingFrames, videoLinks, selectedObject, furniture, currentHandle, activeRoomId } = useRoomStore()
  ...
  return <section className="yt-player docked" aria-label="유튜브 재생">
    <ResumingIframe key={docked} videoId={videoId} frameId={docked} sessionKey={playbackKey(currentHandle, activeRoomId, docked, 'youtube')} extra="autoplay=1&playsinline=1&mute=1" />
  </section>
}
