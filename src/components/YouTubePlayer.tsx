...
export default function YouTubePlayer() {
  ...
  return <section className="yt-player docked" aria-label="유튜브 재생">
    <ResumingIframe key={docked} videoId={videoId} frameId={docked} resumeKey={videoResumeKey(currentHandle, activeRoomId, docked)} extra="autoplay=1&playsinline=1&mute=1" />
  </section>
}
