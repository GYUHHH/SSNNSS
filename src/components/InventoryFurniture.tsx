...
function BannerArt({ id }: { id: string }) {
  ...
  return <mesh position={[0, 0, .041]}><planeGeometry args={[1.98, .54]} /><meshBasicMaterial map={texture} /></mesh>
}
